...
//find data from sessionvariable
 $name= $_SESSION['name'];
     ...
     <div class="container-fluid">
         <div class="container">
            <div class="text-center">
                <h4 style="padding-top: 20px; color: red;"><i><b>hello, <?php echo "$name" ?></b></i></h4>
                <p style="font-size: 20px; color: blue;">Your Total Amount is: <b><?php echo "$amount"; ?><b></p>
                <div class="d-flex" style="margin-left: 39%; margin-bottom: 15px;">   
                 <a href="withdrow.php" class="btn btn-danger">withdrow money</a>
                <a style="margin-left: 30px;" href="addmoney.php" class="btn btn-danger">Add money</a>
             </div>
            </div>
         </div>
     </div>
                 ...
                 <div class="row">
                     <div class=" col-lg-12 text-center">
                       <div style="margin-top:20px;">
                         <input type="submit" name="submit" class="btn btn-primary" value="Show Transection">
                         </div>
                     </div>  
                 </div>
                </form>
